...
<body>
 ...
 <div class="container">
  ...
  <button type="button" class="btn btn-primary" id ="category-body">Science</button>
      <!-- Modal -->
  ...
  <button type="button" class="btn btn-primary"data-toggle="modal" data-target="#commerceModal">Commerce</button>
  
  
   
     <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#artsModal">Arts</button>
...
<div class="container">
  ...
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Add New Book</button>
